  ...
  <div class="container">
    <?php
      ...
      echo '<div class="class" data-toggle="modal" data-target=".bs-example-modal-lg" id="addClass">
          <span class=""> <img src="img/add.svg" alt="Add Class" width="55px"> </span>
        </div>
      </div>';
    ?>
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CSE-734">
              <select class="form-control" name="section">
              <option value="-1" selected disabled>Choose Section</option>
              <?php foreach(range(1,7) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <select class="form-control" name="semester">
              <option value="-1" selected disabled>Choose Semester</option>
              <?php foreach(range(1,8) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 734/CN/20)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 734/CN/20)">
