...
<html>
 ...
 <body>
  <div id="header" class="clearfix">
    <h1>Chouksey Engineering College</h1>
    <h3>Edit Class</h3>
  </div>
  <nav class="navbar navbar-default" id="sub-menu" style="background-color: #66cdaa;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-left">
        <li><a href="teacher.php"> <img src="img/home.svg" alt="Home" width="24px"> Home</a></li>
        <li><a href="profile.php"> <img src="img/user.svg" alt="Faculty Profile" width="24px"> Profile</a></li>
        <li class="active"><a href="class.php"> <img src="img/four-squares-with-frame-shape.svg" alt="Dashboard" width="24px"> Classes</a></li>
        <li><a href="statistics.php"> <img src="img/stats.svg" alt="Statistics" width="24px"> Statistics</a></li>
        <li><a href="logout.php"> <img src="img/log-out.svg" alt="Logout" width="24px"> Logout</a></li>
      </ul>
    </div>
  </nav>
  <div class="container">
